...
import { SECTIONS, CHAT_EXPIRATION_HOURS } from "@/lib/constants";
...
interface Chat {
    ...
    description: string;
    section_id: string;
    active_users: number; // Placeholder, would require a separate counter or joining
    created_at: string;
}
...
export default function SectionPage() {
    ...
    const section = SECTIONS.find((s) => s.id === sectionId) || SECTIONS[0]; // Fallback to avoid crash
    ...
    useEffect(() => {
        ...
        // Subscribe to new chats in this section
